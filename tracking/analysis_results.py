...
trackers = []
dataset_name = 'otmj_cross'#analysis lasot
"""stark"""
...
'''TrackingmambaV2'''
# vitb_refocus_otmjtir_ep60  focustrack_single_030  PromptVT  sutrack  ORTrack  trackingmambatir
trackers.extend(trackerlist(name='trackingmambav2', parameter_name='TrackingmambaV2-ep150-full-256', dataset_name=dataset_name,
                            save_name='otmj_cross', run_ids=None, display_name='TrackingmambaV2256_215')) # analysis 150th epoch
