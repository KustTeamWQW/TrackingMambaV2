...
trackers = []
dataset_name = 'otmj'#analysis lasot
"""stark"""
...
'''TrackingMambaV2'''
trackers.extend(trackerlist(name='trackingmambav2', parameter_name='TrackingMambaV2', dataset_name=dataset_name,
                            save_name='trackingmambav2_hivitb_v1-282', run_ids=None, display_name='TrackingMambaV2')) # analysis 150th epoch
