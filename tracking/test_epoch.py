...
def main(num, dataset, cfg, savename):
    ...
    parser.add_argument('--tracker_param', type=str, default='TrackingMambaV2', help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='trackingmambav2'+str(num), help='Name of save file.')
...
def set_state(state, tracker_param):
    path = '/home/z/projects/pythonprojects2/TrackingMambaV2_2/experiments/trackingmambav2/'+tracker_param+'.yaml'
...
if __name__ == '__main__':
    ...
    epoch = 300 # test the 150th epoch
    savename = 'trackingmambav2'+str(epoch)
