...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='trackingmambav2', choices=['trackingmambav2'],
...
if __name__ == "__main__":
    ...
    if args.script == "trackingmambav2":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_trackingmambav2
