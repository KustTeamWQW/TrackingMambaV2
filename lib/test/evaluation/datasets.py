...
dataset_dict = dict(
    ...
    otmj_tir=DatasetInfo(module=pt % "otmj_tir", class_name="OTMJTIRDataset", kwargs=dict()),
    otmj_cross=DatasetInfo(module=pt % "otmj_cross", class_name="OTMJCROSSDataset", kwargs=dict()),
    otmj_cross_random=DatasetInfo(module=pt % "otmj_cross_random", class_name="OTMJCROSSRANDOMDataset", kwargs=dict()),
